...
def lr(X, Y, max_Ite, cv):
    ...
    for k_fold in range(0, cv):
        ...
        X_train, Y_train = X[train_index[k_fold]], Y[train_index[k_fold]]
        X_test, Y_test = X[test_index[k_fold]], Y[test_index[k_fold]]
        modelLR.fit(X_train, Y_train)
        Y_pred = modelLR.predict(X_test)
        scoresLR.loc[k_fold + 1] = [metrics.accuracy_score(Y_test, Y_pred), 0, metrics.f1_score(Y_test, Y_pred, average='macro'), metrics.precision_score(Y_test, Y_pred, average='macro'), metrics.recall_score(Y_test, Y_pred, average='macro')]
        # Corregir el auc
...
def lda(X, Y, cv):
    ...
    for k_fold in range(0, cv):
        ...
        scoresLDA.loc[k_fold + 1] = [metrics.accuracy_score(Y_test, Y_pred), 0, metrics.f1_score(Y_test, Y_pred, average='macro'), metrics.precision_score(Y_test, Y_pred, average='macro'), metrics.recall_score(Y_test, Y_pred, average='macro')]
        # Corregir el auc
...
def knn(X, Y, neighbours, cv):
    ...
    for k_fold in range(0, cv):
        ...
        scoresKNN.loc[k_fold + 1] = [metrics.accuracy_score(Y_test, Y_pred), 0, metrics.f1_score(Y_test, Y_pred, average='macro'), metrics.precision_score(Y_test, Y_pred, average='macro'), metrics.recall_score(Y_test, Y_pred, average='macro')]
        # Corregir el auc
